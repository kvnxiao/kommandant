...
open class CommandParser : ICommandParser {
    ...
    override fun createCommand(instance: Any, method: Method, annotation: CommandAnn): ICommand<Any?> {
        return object : ICommand<Any?>(annotation.prefix, annotation.uniqueName, annotation.description, annotation.usage, annotation.execWithSubcommands, *annotation.aliases) {
            @Throws(InvocationTargetException::class, IllegalAccessException::class)
