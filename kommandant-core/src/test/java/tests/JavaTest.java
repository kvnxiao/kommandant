...
public class JavaTest {
  ...
  public void testAddCommand() {
    ...
    kommandant.addCommand(
        new CommandBuilder<Integer>("testAddCommand2")
            .withAliases("testAddCommand2", "t2")
            .build(((context, opt) -> 2)));
  ...
  public void testAddAnnotatedCommands() {
    ...
    // Process tests.main-sub (parent/child) commands
  ...
  public void testRenameCommand() {
    kommandant.addCommand(
        new CommandBuilder<Integer>("prefixchange")
            .withAliases("prefixchange")
            .build(
                (context, opt) -> {
  ...
  public void testAddCommandDifferentPrefixClash() {
    kommandant.addCommand(
        new CommandBuilder<Integer>("diffPrefixClash")
            .withAliases("diffPrefixClash")
            .withPrefix("!!")
            .build((context, opt) -> 1));
    kommandant.addCommand(
        new CommandBuilder<Integer>("!diffPrefixClash")
